...
# # account클래스를 이용해 a_account인스턴스(객체)를 생성
# a_account = account()
# a_account.set_data('mega', 20, 100)
# print(a_account.__dict__,'네임 스페이스')
# print("="*25)
# print("상호명   :", a_account.name)
# print("영업일수 :", a_account.day)
# print("일수익   :", a_account.money)
# print("월수익   :", a_account.sumMoney())

# # 기존 result에 bouns를 추가 누적 시키는 역할
# a_account.bonus_add(1000)
# print("보너스 추가된 금액 : ",a_account.result)
# print(a_account.bonus)                        # 해당 변수는 인스턴스 변수가 아닌 매개 변수로 함수 종료후 사라짐 출력X
# print("="*25)

# # account클래스를 이용해 b_account인스턴스(객체)를 생성
# b_account = account()
# b_account.set_data('samsung', 22, 300)
# print("상호명   :", b_account.name)
# print("영업일수 :", b_account.day)
# print("일수익   :", b_account.money)
# print("월수익   :", b_account.sumMoney())
# print("="*25)
# =======================================================================================
...
# # account클래스를 이용해 b_account인스턴스(객체)를 생성
# b_account = account('samsung', 22, 300)
# # b_account.set_data('samsung', 22, 300)
# print("상호명   :", b_account.name)
# print("영업일수 :", b_account.day)
# print("일수익   :", b_account.money)
